...
## Purpose
Define requirements for the fake summarizer utility used in testing and development. The fake summarizer generates test summaries when `USE_FAKE_SUMMARIZER` is enabled, allowing developers to test compression logic without calling actual LLM APIs.
